...
export const singleProjectData = [
  {
    ...
    ProjectImages: [
      { id: 1, title: 'AI Companion Interface', img: 'https://images.unsplash.com/photo-1618005182384-a83a8bd57fbe?auto=format&fit=crop&w=800&q=80' }
    ],
    ProjectInfo: {
      ClientHeading: 'About Project',
      CompanyInfo: [
        { id: 1, title: 'Type', details: 'AI Application' },
        { id: 2, title: 'Stack', details: 'FastAPI, React, PostgreSQL, pgvector, Gemini API' },
        { id: 3, title: 'Year', details: '2025' }
      ],
      ObjectivesHeading: 'Description',
      ObjectivesDetails: 'A full-stack learning companion application engineered with semantic search, automated content validation, and a custom personalization engine leveraging Laplace smoothing metrics.',
      Technologies: [
        { title: 'Tech Stack', techs: ['FastAPI', 'React', 'PostgreSQL', 'pgvector', 'Gemini API', 'Laplace Smoothing'] }
      ],
      ProjectDetailsHeading: 'Features',
      ProjectDetails: [
        { id: 1, details: 'Built a full-stack learning application engineered with semantic search, automated content validation, and a custom personalization engine leveraging Laplace smoothing metrics' },
        { id: 2, details: 'Integrated pgvector for context retrieval, tracking information accuracy through vector similarity calculations and cosine distance matching driven by the Gemini API' }
      ],
      SocialSharingHeading: 'Share This',
      SocialSharing: [],
      github: {
        url: 'https://github.com/ubaidullah-ctrl/adaptive-ai-companion',
      }
    }
  },
  {
