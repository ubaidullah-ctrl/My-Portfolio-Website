			...
			<div className="w-full sm:w-1/3 text-left">
				...
				<div>
					...
					<div className="flex items-center gap-3 mt-5">
						...
						{/* GitHub link below Share This section */}
						{singleProjectData.ProjectInfo.github && (
					   <a
						   href={singleProjectData.ProjectInfo.github.url}
						   target="_blank"
						   rel="noreferrer"
						   aria-label="GitHub Repository"
						   className="bg-ternary-light dark:bg-ternary-dark text-gray-400 hover:text-primary-dark dark:hover:text-primary-light p-2 rounded-lg shadow-sm duration-500 ml-2"
					   >
